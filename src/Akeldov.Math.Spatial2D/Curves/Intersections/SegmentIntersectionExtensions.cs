...
namespace Akeldov.Math.Spatial2D.Curves
{
    ...
    {
        /// <summary>
        /// Returns isolated point intersections between a segment and a ray using exact comparisons.
        /// </summary>
        ...
        /// <summary>
        /// Returns the distinct isolated point intersections between a segment and a parameterized segment chain using exact comparisons.
        /// </summary>
        /// <param name="source">The source segment.</param>
        ...
        public static List<PointXY> GetPointIntersections(this Segment source, ParameterizedSegmentChain segmentChain)
        {
        ...
        /// <summary>
        /// Returns the isolated point intersections between a segment and an arc using exact comparisons.
        /// </summary>
        /// <param name="source">The source segment.</param>
        ...
        public static List<PointXY> GetPointIntersections(this Segment source, Arc arc)
        {
        ...
        /// <summary>
        /// Returns the isolated point intersections between a segment and a parameterized arc using exact comparisons.
        /// </summary>
        /// <param name="source">The source segment.</param>
        ...
        public static List<PointXY> GetPointIntersections(this Segment source, ParameterizedArc arc)
        {
        ...
        /// <summary>
        /// Returns isolated point intersections between a segment and a quadratic Bezier curve by solving the original curve polynomial.
        /// </summary>
        /// <param name="source">The source segment.</param>
        /// <param name="curve">The quadratic Bezier curve to intersect with the source segment.</param>
        ...
        public static List<PointXY> GetPointIntersections(this Segment source, QuadraticBezier curve)
        {
        ...
        /// <summary>
        /// Returns isolated point intersections between a segment and a cubic Bezier curve by solving the original curve polynomial.
        /// </summary>
        /// <param name="source">The source segment.</param>
        /// <param name="curve">The cubic Bezier curve to intersect with the source segment.</param>
        /// <returns>A new mutable list owned by the caller, ordered from the curve's start point to its end point. Points belonging to continuous overlaps are omitted.</returns>
        public static List<PointXY> GetPointIntersections(this Segment source, CubicBezier curve)
        {
