...
{
    /// <summary>
    /// Provides intersection calculations for <see cref="Arc"/>.
    /// </summary>
    public static class ArcIntersectionExtensions
    {
        ...
        /// <summary>
        /// Returns the isolated point intersections between an arc and a parameterized arc using exact comparisons.
        /// </summary>
        /// <param name="source">The source arc.</param>
        ...
        public static List<PointXY> GetPointIntersections(this Arc source, ParameterizedArc arc)
        {
        ...
        /// <summary>
        /// Returns isolated point intersections between an arc and a quadratic Bezier curve by numerically isolating the roots of the original curve-circle polynomial above float precision.
        /// </summary>
        /// <param name="source">The source arc.</param>
        ...
        public static List<PointXY> GetPointIntersections(this Arc source, QuadraticBezier curve)
        {
        ...
        /// <summary>
        /// Returns isolated point intersections between an arc and a cubic Bezier curve by numerically isolating the roots of the original curve-circle polynomial above float precision.
        /// </summary>
        /// <param name="source">The source arc.</param>
        /// <param name="curve">The cubic Bezier curve to intersect with the source arc.</param>
        /// <returns>A new mutable list owned by the caller, ordered from the curve's start point to its end point.</returns>
        public static List<PointXY> GetPointIntersections(this Arc source, CubicBezier curve)
        {
        ...
        /// <summary>Returns isolated point intersections between an arc and a B-spline by solving the original polynomial spline-circle equations.</summary>
        /// <param name="source">The source arc.</param>
        /// <param name="curve">The B-spline to intersect with the source arc.</param>
        ...
        public static List<PointXY> GetPointIntersections(this Arc source, BSpline curve)
        {
        ...
        /// <summary>Returns isolated point intersections between an arc and a NURBS curve by solving the original rational spline-circle equations.</summary>
        /// <param name="source">The source arc.</param>
        /// <param name="curve">The NURBS curve to intersect with the source arc.</param>
        /// <returns>A new mutable list owned by the caller, ordered from the spline's start point to its end point. Continuous overlaps are omitted.</returns>
        public static List<PointXY> GetPointIntersections(this Arc source, Nurbs curve)
        {
