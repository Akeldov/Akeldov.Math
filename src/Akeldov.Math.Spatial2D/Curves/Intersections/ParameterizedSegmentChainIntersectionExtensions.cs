...
namespace Akeldov.Math.Spatial2D.Curves
{
    ...
    {
        /// <summary>
        /// Returns isolated point intersections between a parameterized segment chain and a ray using exact comparisons.
        /// </summary>
        /// <param name="source">The source parameterized segment chain.</param>
        /// <param name="ray">The ray to intersect with the source chain.</param>
        ...
        public static List<PointXY> GetPointIntersections(this ParameterizedSegmentChain source, Ray ray)
        {
        ...
        /// <summary>
        /// Returns the distinct isolated point intersections between a parameterized segment chain and an arc using exact comparisons.
        /// </summary>
        /// <param name="source">The source segment chain.</param>
        /// <param name="arc">The arc to intersect with the source chain.</param>
        /// <returns>A new mutable list owned by the caller, ordered counterclockwise from the arc's start angle.</returns>
        public static List<PointXY> GetPointIntersections(this ParameterizedSegmentChain source, Arc arc)
        {
        ...
        /// <summary>
        /// Returns distinct isolated point intersections between a parameterized segment chain and a cubic Bezier curve by solving the original curve polynomial.
        /// </summary>
        /// <param name="source">The source parameterized segment chain.</param>
        /// <param name="curve">The cubic Bezier curve to intersect with the source chain.</param>
        /// <returns>A new mutable list owned by the caller, ordered from the curve's start point to its end point. Points belonging to continuous overlaps are omitted.</returns>
        public static List<PointXY> GetPointIntersections(this ParameterizedSegmentChain source, CubicBezier curve)
        {
        ...
        /// <summary>Returns isolated point intersections between a parameterized segment chain and a B-spline by solving the original polynomial spline spans.</summary>
        /// <param name="source">The source segment chain.</param>
        /// <param name="curve">The B-spline to intersect with the source chain.</param>
        ...
        public static List<PointXY> GetPointIntersections(this ParameterizedSegmentChain source, BSpline curve)
        {
        ...
        /// <summary>Returns isolated point intersections between a parameterized segment chain and a NURBS curve by solving the original rational spline spans.</summary>
        /// <param name="source">The source segment chain.</param>
        /// <param name="curve">The NURBS curve to intersect with the source chain.</param>
        /// <returns>A new mutable list owned by the caller, ordered from the spline's start point to its end point. Continuous overlaps are omitted.</returns>
        public static List<PointXY> GetPointIntersections(this ParameterizedSegmentChain source, Nurbs curve)
        {
