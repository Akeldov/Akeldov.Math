...
namespace Akeldov.Math.Spatial2D.Curves
{
    ...
    public static class ParameterizedSegmentIntersectionExtensions
    {
        ...
        /// <summary>
        /// Returns isolated point intersections between a parameterized segment and a quadratic Bezier curve by solving the original curve polynomial.
        /// </summary>
        /// <param name="source">The source parameterized segment.</param>
        ...
        public static List<PointXY> GetPointIntersections(this ParameterizedSegment source, QuadraticBezier curve)
        {
            return SegmentIntersectionExtensions.GetPointIntersections((Segment)source, curve);
        }

        /// <summary>
        /// Returns isolated point intersections between a parameterized segment and a cubic Bezier curve by solving the original curve polynomial.
        /// </summary>
        /// <param name="source">The source parameterized segment.</param>
        /// <param name="curve">The cubic Bezier curve to intersect with the source segment.</param>
        /// <returns>A new mutable list owned by the caller, ordered from the curve's start point to its end point. Points belonging to continuous overlaps are omitted.</returns>
        public static List<PointXY> GetPointIntersections(this ParameterizedSegment source, CubicBezier curve)
        {
            return SegmentIntersectionExtensions.GetPointIntersections((Segment)source, curve);
        }

        /// <summary>Returns isolated point intersections between a parameterized segment and a B-spline by solving the original polynomial spline spans.</summary>
        /// <param name="source">The source parameterized segment.</param>
        ...
        public static List<PointXY> GetPointIntersections(this ParameterizedSegment source, BSpline curve)
        {
        ...
        /// <summary>Returns isolated point intersections between a parameterized segment and a NURBS curve by solving the original rational spline spans.</summary>
        /// <param name="source">The source parameterized segment.</param>
        /// <param name="curve">The NURBS curve to intersect with the source segment.</param>
        /// <returns>A new mutable list owned by the caller, ordered from the spline's start point to its end point. Continuous overlaps are omitted.</returns>
        public static List<PointXY> GetPointIntersections(this ParameterizedSegment source, Nurbs curve)
        {
