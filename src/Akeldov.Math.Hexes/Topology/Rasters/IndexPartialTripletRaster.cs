...
{
    /// <summary>
    /// Rasterizes the in-bounds hex indices surrounding each sampled point.
    /// </summary>
    public sealed class IndexPartialTripletRaster : ISpatialRaster<PartialTriplet<VectorXYInt>>
    {
        ...
        public IndexPartialTripletRaster(HexMapGeometry hexMapGeometry)
            : this(hexMapGeometry, hexMapGeometry.ToRasterGeometry(1f))
        {
        }

        /// <summary>
        /// Initializes a clipped index raster over the specified sampling geometry.
        /// </summary>
        /// <param name="hexMapGeometry">The source hex map geometry.</param>
        /// <param name="rasterGeometry">The geometry that defines the sampled raster origin, size, and resolution.</param>
        public IndexPartialTripletRaster(
        ...
        /// <summary>
        /// Gets the in-bounds surrounding hex indices at the specified raster coordinates.
        /// </summary>
        ...
        /// <summary>
        /// Gets the in-bounds surrounding hex indices at the specified flat raster index.
        /// </summary>
        ...
        /// <summary>
        /// Tries to get the in-bounds surrounding hex indices at the specified raster coordinates.
        /// </summary>
        /// <param name="gridIndex">The X/Y coordinates of the raster cell.</param>
        /// <param name="indexTriplet">Receives the present surrounding hex indices.</param>
        /// <returns><see langword="true"/> when the cell contains at least one in-bounds hex index; otherwise, <see langword="false"/>.</returns>
