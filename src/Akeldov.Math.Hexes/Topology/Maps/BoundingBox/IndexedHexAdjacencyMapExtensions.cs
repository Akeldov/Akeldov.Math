...
{
    public static class IndexedHexAdjacencyMapExtensions
    {
        public static VectorXY GetBoundingBoxSize(this IndexedHexAdjacencyMap hexAdjacencyMap, float hexRadius)
        {
