...
{
    /// <summary>
    /// Defines how XY index labels are rendered inside topology cells.
    /// </summary>
    public readonly struct HexMapTopologyXYLabelsRasterizationOptions
    {
        /// <summary>
        /// Initializes XY label rasterization options.
        /// </summary>
        public HexMapTopologyXYLabelsRasterizationOptions(
            TrueTypeFont font,
            float fontSize,
            byte color,
            float edgeFalloff,
