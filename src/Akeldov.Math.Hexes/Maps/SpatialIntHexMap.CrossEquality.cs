...
namespace Akeldov.Math.Hexes
{
    ...
    {
        /// <summary>Creates a spatial Boolean map identifying equal cells in spatial and topology-only integer maps.</summary>
        ...
        /// <summary>Creates a spatial Boolean map identifying equal cells in topology-only and spatial integer maps.</summary>
        ...
        /// <summary>Creates a spatial Boolean map identifying different cells in spatial and topology-only integer maps.</summary>
        /// <param name="left">The spatial source map whose geometry is retained.</param>
        /// <param name="right">The topology-only source map.</param>
        /// <returns>A new mutable spatial Boolean hex map owned by the caller. Neither source map is modified.</returns>
        /// <exception cref="ArgumentNullException">Thrown when either source map is <see langword="null"/>.</exception>
        ...
        /// <summary>Creates a spatial Boolean map identifying different cells in topology-only and spatial integer maps.</summary>
        /// <param name="left">The topology-only source map.</param>
        /// <param name="right">The spatial source map whose geometry is retained.</param>
        /// <returns>A new mutable spatial Boolean hex map owned by the caller. Neither source map is modified.</returns>
        /// <exception cref="ArgumentNullException">Thrown when either source map is <see langword="null"/>.</exception>
        ...
        /// <summary>Creates a spatial Boolean map identifying equal cells in a spatial integer map and a floating-point map.</summary>
        /// <param name="left">The spatial integer source map whose geometry is retained.</param>
        /// <param name="right">The topology-only floating-point source map.</param>
        /// <returns>A new mutable spatial Boolean hex map owned by the caller. Neither source map is modified.</returns>
        /// <exception cref="ArgumentNullException">Thrown when either source map is <see langword="null"/>.</exception>
        /// <exception cref="ArgumentException">Thrown when the source maps do not have the same topology.</exception>
        ...
        /// <summary>Creates a spatial Boolean map identifying equal cells in a floating-point map and a spatial integer map.</summary>
        /// <param name="left">The topology-only floating-point source map.</param>
        /// <param name="right">The spatial integer source map whose geometry is retained.</param>
        /// <returns>A new mutable spatial Boolean hex map owned by the caller. Neither source map is modified.</returns>
        /// <exception cref="ArgumentNullException">Thrown when either source map is <see langword="null"/>.</exception>
        /// <exception cref="ArgumentException">Thrown when the source maps do not have the same topology.</exception>
        ...
        /// <summary>Creates a spatial Boolean map identifying different cells in a spatial integer map and a floating-point map.</summary>
        /// <param name="left">The spatial integer source map whose geometry is retained.</param>
        /// <param name="right">The topology-only floating-point source map.</param>
        /// <returns>A new mutable spatial Boolean hex map owned by the caller. Neither source map is modified.</returns>
        /// <exception cref="ArgumentNullException">Thrown when either source map is <see langword="null"/>.</exception>
        ...
        /// <summary>Creates a spatial Boolean map identifying different cells in a floating-point map and a spatial integer map.</summary>
        /// <param name="left">The topology-only floating-point source map.</param>
        /// <param name="right">The spatial integer source map whose geometry is retained.</param>
        /// <returns>A new mutable spatial Boolean hex map owned by the caller. Neither source map is modified.</returns>
        /// <exception cref="ArgumentNullException">Thrown when either source map is <see langword="null"/>.</exception>
