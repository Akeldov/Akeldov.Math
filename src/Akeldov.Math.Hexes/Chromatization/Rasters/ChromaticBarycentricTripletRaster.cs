...
namespace Akeldov.Math.Hexes.Topology
{
    ...
    /// </summary>
    public sealed class ChromaticBarycentricTripletRaster : ISpatialRaster<ChromaticTriplet<float>>
    {
        ...
        public ChromaticBarycentricTripletRaster(HexMapGeometry hexMapGeometry)
        ...
        public ChromaticBarycentricTripletRaster(
            ...
            RasterGeometry rasterGeometry)
        {
            ...
            var barycentricRaster = new BarycentricTripletRaster(hexMapGeometry, rasterGeometry);
            var chromaticIndexRaster = new ChromaticIndexTripletRaster(hexMapGeometry, rasterGeometry);

            for (int index = 0; index < _values.Length; index++)
            {
                Triplet<float> barycentric = barycentricRaster[index];
