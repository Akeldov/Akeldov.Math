...
- Geometric and parameterized infinite line primitives, plus curve/path contracts for projection, distance measurement, finite length, endpoints, and parameterization.
