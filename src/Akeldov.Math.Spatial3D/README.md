...
- Geometric and parameterized infinite lines, directed rays, geometric and parameterized finite segments and segment chains, Bezier, B-spline, and NURBS paths, and curve/path contracts for projection, distance measurement, finite length, endpoints, and parameterization.
