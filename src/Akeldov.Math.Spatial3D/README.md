...
- Geometric and parameterized infinite lines, directed rays, geometric and parameterized finite segments and segment chains, Bezier and B-spline paths, and curve/path contracts for projection, distance measurement, finite length, endpoints, and parameterization.
