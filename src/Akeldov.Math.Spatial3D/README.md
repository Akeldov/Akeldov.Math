...
- Geometric and parameterized infinite lines, directed rays, geometric and parameterized finite segments and segment chains, quadratic Bezier paths, and curve/path contracts for projection, distance measurement, finite length, endpoints, and parameterization.
