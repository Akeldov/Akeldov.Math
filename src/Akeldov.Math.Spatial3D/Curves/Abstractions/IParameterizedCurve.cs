...
{
    /// <summary>
    /// Represents a three-dimensional curve parameterized by a curve coordinate.
    /// </summary>
    /// <remarks>
    ...
    public interface IParameterizedCurve : ICurve
    {
        ...
        /// </exception>
        PointXYZ GetPoint(float curveCoordinate);
        ...
        /// <returns>
        /// The projection point, its curve coordinate in the same coordinate system as <see cref="GetPoint"/>,
        /// and the distance to this curve.
        /// </returns>
        /// <exception cref="System.ArgumentOutOfRangeException">
        /// Thrown when <paramref name="point"/> has a non-finite coordinate.
        /// </exception>
        ParameterizedCurveProjection ProjectWithParameter(PointXYZ point);
    }
}
