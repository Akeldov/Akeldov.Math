...
Законченный RGB-пример отображения номеров классов приведён на странице
[«Визуализация ChromaticIndexTripletRaster»](../../tutorials/visualizing-chromatic-index-triplet-raster.md).
