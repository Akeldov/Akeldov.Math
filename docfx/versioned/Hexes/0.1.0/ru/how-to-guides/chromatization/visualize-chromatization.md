...
Иллюстрации, перестановка весов и формула смешивания приведены в учебнике
[«Хроматизация и барицентрическая интерполяция»](../../tutorials/chromatic-barycentric-interpolation.md).
