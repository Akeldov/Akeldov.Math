...
сосед по ребру внутри топологии. В версии `0.1.0` у Septuplet-растров нет `TryGetValue`, поэтому проверяйте координаты растра или используйте проверяемый индексатор `[VectorXYInt]`, как выше.
