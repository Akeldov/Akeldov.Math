...
Законченные RGB-примеры с изображениями приведены на страницах
[«Визуализация IndexTripletRaster»](../../tutorials/visualizing-index-triplet-raster.md) и
[«Визуализация IndexPartialTripletRaster»](../../tutorials/visualizing-index-partial-triplet-raster.md).
