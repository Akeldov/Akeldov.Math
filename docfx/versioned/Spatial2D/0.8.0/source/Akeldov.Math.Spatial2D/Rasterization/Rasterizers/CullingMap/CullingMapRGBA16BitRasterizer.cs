...
namespace Akeldov.Math.Spatial2D.Rasterization
{
    ...
    public sealed class CullingMapRGBA16BitRasterizer<TPointSource> :
        ISpatialRasterizer<IReadOnlyList<TPointSource>, RGBA16BitColor>
        where TPointSource : IPointInfluenceSource
    {
        ...
        /// <inheritdoc/>
        public SpatialRaster<RGBA16BitColor> Rasterize(IReadOnlyList<TPointSource> source, RasterGeometry grid)
        {
            if (source == null)
