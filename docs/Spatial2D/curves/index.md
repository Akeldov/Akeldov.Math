...
| - | <img class="curve-overview-thumbnail" style="width: 160px; height: 160px; max-width: none; object-fit: contain;" alt="Arbitrary-degree Bezier growing-thickness raster" src="../../assets/spatial2d/curves/bezier-curve-growing-thickness.png"><br><span class="curve-overview-link">[`BezierCurve`](bezier/bezier-curve.md)</span> | <span class="curve-coordinate-domain">`[0, Length]`</span> | Arbitrary-degree Bezier backed by copied control points. |
