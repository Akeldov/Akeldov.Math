...
| - | <img class="curve-overview-thumbnail" alt="Quadratic Bezier growing-thickness raster" src="../../assets/spatial2d/curves/quadratic-bezier-growing-thickness.png"><br><span class="curve-overview-link">`QuadraticBezier`</span> | <span class="curve-coordinate-domain">`[0, Length]`</span> | TrueType-style Bezier segment with one control point. |
| - | <img class="curve-overview-thumbnail" alt="Cubic Bezier growing-thickness raster" src="../../assets/spatial2d/curves/cubic-bezier-growing-thickness.png"><br><span class="curve-overview-link">`CubicBezier`</span> | <span class="curve-coordinate-domain">`[0, Length]`</span> | Four-point Bezier segment commonly used by vector drawing formats. |
| - | <img class="curve-overview-thumbnail" alt="Arbitrary-degree Bezier growing-thickness raster" src="../../assets/spatial2d/curves/bezier-curve-growing-thickness.png"><br><span class="curve-overview-link">`BezierCurve`</span> | <span class="curve-coordinate-domain">`[0, Length]`</span> | Arbitrary-degree Bezier backed by copied control points. |
