...
Use multiple contours with the even-odd fill rule.
...
bool insideOuterArea = region.Contains(new PointXY(0.5f, 0.5f));
bool insideHole = region.Contains(new PointXY(2f, 2f));
