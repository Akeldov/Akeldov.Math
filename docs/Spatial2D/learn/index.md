...
This section covers the main building blocks in Akeldov.Math.Spatial2D.

Start with vectors and curves for core geometry operations, then move to regions, rasterization, sampling, partitioning, and influence fields for higher-level spatial workflows.
